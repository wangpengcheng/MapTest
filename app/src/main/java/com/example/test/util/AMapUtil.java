...
public class AMapUtil {
	...
	/**
	 * 把集合体的LatLng转化为集合体的LatLonPoint
	 */
	public static ArrayList<LatLonPoint> convertArrList2(List<LatLng> shapes) {
		ArrayList<LatLonPoint> lineShapes = new ArrayList<LatLonPoint>();
		for (LatLng point : shapes) {
	...
	/**
	 * 把集合体的BusStationItem转化为集合体的LatLonPoint
	 */
	public static ArrayList<LatLonPoint> convertArrList3(List<BusStationItem> shapes) {
		ArrayList<LatLonPoint> lineShapes = new ArrayList<LatLonPoint>();
		for (BusStationItem point : shapes) {
			LatLonPoint latLngTemp = point.getLatLonPoint();
			lineShapes.add(latLngTemp);
		}
		return lineShapes;
	}
