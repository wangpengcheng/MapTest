...
public class BusLineOverlay {
    ...
    private MarkerOptions getMarkerOptions(int index) {
        ...
        if (index == 0) {
            options.icon(getStartBitmapDescriptor()).anchor(0.5f,0.5f);
        } else if (index == mBusStations.size() - 1) {
            options.icon(getEndBitmapDescriptor()).anchor(0.5f,0.5f);
        } else {
    ...
    protected BitmapDescriptor getStartBitmapDescriptor() {
        ...
        startBit = BitmapDescriptorFactory.fromResource(R.drawable.amap_bus);
        return startBit;
    }

    protected BitmapDescriptor getEndBitmapDescriptor() {
       // endBit = BitmapDescriptorFactory.fromResource(R.drawable.amap_bus);
        endBit = BitmapDescriptorFactory.fromResource(R.drawable.amap_bus);
        return endBit;
    }
    ...
    public Marker GetMarker (int index){
        return this.mBusStationMarks.get(index);
